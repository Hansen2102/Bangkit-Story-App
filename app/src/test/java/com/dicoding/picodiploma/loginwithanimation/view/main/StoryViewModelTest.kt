...
class StoryViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1c2VyLU43TWxGUW1Bc3lsVXdPOU8iLCJpYXQiOjE3MTU3NjMxMzV9.MEBAX7bJ1iJJ3seTzH7QTNsEoppvWZD3bj724Yy5xUM"
        Mockito.`when`(storyRepository.userStories(token)).thenReturn(expectedStory)

        val storyViewModel = StoryViewModel(storyRepository)
        storyViewModel.setToken(token)
        val actualStory: PagingData<ListStoryItem> = storyViewModel.listStory.getOrAwaitValue()
